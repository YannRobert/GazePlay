...
public abstract class Stats {
     ...
     * 
     * This does not fit all games, as some game may have multiple target available at the same time. This better fit
     * games where only 1 goal/target is available at anytime.
     * 
     * This method is needed in case a new goal/target is not available immediatly when the previous goal/target was
     * reached. Sometime the game waits for a few seconds after a target has been reached before making a new one
     * available.
     * 
     * This permits to measure the actual duration it took to the player between the time the goal is available and the
     * time the goal is reached by the player.
     */
